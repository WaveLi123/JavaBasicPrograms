...
public class AquaSimGUI extends DisplayPanel
{
    ...
    private static final int DEFAULT_STEPS = 10; // # steps to run simulation				//changed by jkd,1st Oct in 2014
    ...
    private int numFish;       // number of fish in aquarium			//changed by jkd,1st Oct in 2014
    //private int numSteps = DEFAULT_STEPS;     // number of sim. steps to run
    private int numSteps;     // number of sim. steps to run						//changed by jkd,1st Oct in 2014
    ...
    private TextFieldView numFishTF =
        new TextFieldView(
            "" + numFish,           // initial value displayed in the TFV
    ...
    private TextFieldView numStepsTF =
        new TextFieldView(
            "" + numSteps,          // initial value displayed in the TFV
            "Number must be positive:",  // prompt for correcting input
            "Incorrect input");          // title for the error dialog box
