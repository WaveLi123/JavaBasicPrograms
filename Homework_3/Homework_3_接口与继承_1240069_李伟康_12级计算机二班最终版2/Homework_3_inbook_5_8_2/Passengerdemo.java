...
public class Passengerdemo {
	//data
	static Passenger [] passenger = new Passenger[23];
	static int Number;
	...
	static void main_Passenger(){								
		...
		case 2:	System.out.println("There are "+Number+" objects in this Models");
				...
				valid = false;
				Clear();				
				passenger[sub_choice].user_update();				
				main_Passenger();
				break;
		...
		case 3:	System.out.println("There are "+Number+" objects in this Models");
				...
				valid = false;
				Clear();				
				passenger[sub_choice].user_delete();				
				main_Passenger();
				break;
		...
		case 4:	System.out.println("There are "+Number+" objects in this Models");
				...
				valid = false;
				Clear();
				passenger[sub_choice].user_show();				
				main_Passenger();
				break;
