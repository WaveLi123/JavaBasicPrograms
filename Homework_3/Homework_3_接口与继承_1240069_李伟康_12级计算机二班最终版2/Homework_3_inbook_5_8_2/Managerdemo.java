...
public class Managerdemo {
	//data
	static Manager [] manager = new Manager[23];
	static int Number;
	...
	static void main_Manager(){								
		...
		switch(choice){
		case 1:	Number ++;				
				manager[Number] = new Manager();
				manager[Number].employee = new Employee();
				manager[Number].user_insert();		
				Clear();
				main_Manager();				
		...
		case 2:	System.out.println("There are "+Number+" objects in this Models");
				...
				valid = false;
				Clear();				
				manager[sub_choice].user_update();				
				main_Manager();
				break;
		...
		case 3:	System.out.println("There are "+Number+" objects in this Models");
				...
				valid = false;
				Clear();				
				manager[sub_choice].user_delete();				
				main_Manager();
				break;
